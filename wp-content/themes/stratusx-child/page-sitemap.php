		...
		<div class="menu-item sub-menu-item">
			<div>
				...
				<ul class="sub-menu">
					...
					<!-- New links added -->
					<li class="menu-link"><a href="https://healthray.com/whitepaper/" target="_blank">Whitepaper</a></li>
					<li class="menu-link"><a href="https://healthray.com/case-studies/" target="_blank">Case Studies</a></li>
					<li class="menu-link"><a href="https://healthray.com/faqs/" target="_blank">FAQs</a></li>
					<li class="menu-link"><a href="https://healthray.com/events/" target="_blank">Events</a></li>
					<li class="menu-link"><a href="https://healthray.com/become-a-partner/" target="_blank">Become a Partner</a></li>
					<li class="menu-link"><a href="https://healthray.com/testimonial/" target="_blank">Testimonials</a></li>
					<li class="menu-link"><a href="https://healthray.com/awards/" target="_blank">Awards</a></li>
					<li class="menu-link"><a href="https://healthray.com/pdf/Healthray.pdf" target="_blank">Brochure</a></li>
				</ul>
			</div>
	...
	<div class="container">
		<div class="menu-item sub-menu-item">
			<div>
				...
				<ul class="sub-menu">
					<?php
					// Query all pages using the 'speciality.php' template
					$args = [
						'post_type'  => 'page',
					...
					$speciality_pages = new WP_Query($args);
					if ($speciality_pages->have_posts()) :
					while ($speciality_pages->have_posts()) :
					$speciality_pages->the_post();
					?>
					<li class="menu-link"> <a href="<?php the_permalink(); ?>" target="_blank"><?php the_title(); ?></a> </li>
					<?php
					endwhile;
					wp_reset_postdata();
					endif;
		...
		<div class="menu-item sub-menu-item">
			<div>
				...
				<ul class="sub-menu">
					...
					<li class="menu-link"><a href="https://healthray.com/doctor-appointment-system/" target="_blank"> Doctor Appointment System </a></li> 
				</ul>
			</div>
	...
	<div class="container">
		<div class="menu-item sub-menu-item">
			<div>
				<h2>Legal Pages</h2>
				<ul class="sub-menu">
					<li class="menu-link"><a href="https://healthray.com/privacy-policy/" target="_blank">Privacy Policy</a></li>
					<li class="menu-link"><a href="https://healthray.com/terms-condition/" target="_blank">Terms &amp; condition</a></li>
					<li class="menu-link"><a href="https://healthray.com/refund-cancellation-policy/" target="_blank">Refund &amp; Cancellation Policy</a></li>
