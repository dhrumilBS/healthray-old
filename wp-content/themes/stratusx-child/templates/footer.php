	...
	<div class="container">
		<div class="th-d-flex">
			...
			<div class="copyright copyright-text">
				<p>
					<span class="footer_copy">&copy; Healthray & Healthray Sales 2026 | All Rights Reserve</span>
					-
