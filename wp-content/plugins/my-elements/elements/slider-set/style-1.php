<style>
	.ml-slider-set-container .custom-pagination {
		display: flex;
	...
	.ml-slider-set-container .custom-pagination::before {
		width: 90%;
		content: '';
		position: absolute;
		left: 20px;
	...
	.ml-slider-set-container .custom-pagination .dot {
		width: 40px;
		height: 40px;
		border-radius: 50%;
		display: flex;
	...
	.ml-slider-set-container .custom-pagination .dot:last-child {
		margin-right: 0;
	}

	.ml-slider-set-container .custom-pagination .dot.active {
		background-color: #1e90ff;
		color: white;
		border-color: #1e90ff;
	}

	.product-slider-style-1:not(.owl-loaded) {
		display: flex;
		flex-wrap: nowrap;
		overflow: hidden;
	}
	...
	.product-slider-style-1 .slide .row {
		display: flex;
		position: relative;
	}

	.product-slider-style-1 .slide .column {
		position: relative;
		max-width: 50%;
	}

	.product-slider-style-1 .slide .right-column {
		position: relative;
	}

	.product-slider-style-1 .slide .right-column .big-number {
		color: #D1DEFF;
		font-size: 118px;
		font-weight: 700;
		z-index: -1;
	...
	.product-slider-style-1 .slide .right-column .slider-content {
		padding-left: 72px;
	...
	.owl-loaded.product-slider-style-1 .slide .right-column .slider-content {
		opacity: 0;
		left: 150px;
	}

	.owl-loaded.product-slider-style-1 .active .right-column .slider-content {
		opacity: 1;
		left: 0;
	}

	.product-slider-style-1 .slide .right-column .slider-content .slide-number {
		font-size: 45px;
		font-weight: 700;
		color: var(--hr-secondary-color);
	}
	...
	@media screen and (max-width: 600px) {
		...
		.product-slider-style-1 .slide .column .slide-img {
			max-width: 85%;
			margin: 0 auto;
		}
