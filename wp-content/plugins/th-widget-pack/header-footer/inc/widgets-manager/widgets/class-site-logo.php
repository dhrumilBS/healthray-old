		...
		<div <?= $this->get_render_attribute_string('wrapper'); ?>>
			<?php if ($has_caption) : ?>
				...
				<?php if ($link) : ?>
					...
					?>
					<a data-elementor-open-lightbox="<?= esc_attr($settings['open_lightbox']); ?>" class='<?=  esc_attr($class); ?>' <?= $this->get_render_attribute_string('link'); ?>>
					<?php endif; ?>
					<?php
					if (empty($site_image)) {
						return;
					...
					<div class="hfe-site-logo-set">
						<div class="hfe-site-logo-container">
							<img class="hfe-site-logo-img <?= esc_attr($class_animation); ?>" src="<?= esc_url($image_url); ?>" alt="<?= get_bloginfo() ?>" />
						</div>
					</div>
					<?php if ($link) : ?>
					</a>
				...
				?>
					<?php if (!empty($caption_text)) : ?>
						<div class="hfe-caption-width">
							<figcaption class="widget-image-caption wp-caption-text"><?= wp_kses_post($caption_text); ?></figcaption>
						</div>
					<?php endif; ?>
				</figure>
			<?php endif; ?>
